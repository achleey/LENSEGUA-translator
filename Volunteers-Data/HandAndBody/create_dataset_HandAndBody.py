    ...
    if os.path.isdir(dir_path):
        ...
        for img_path in img_files:
            ...
            if resultsP.pose_landmarks:
                ...
                pose_data.extend([resultsP.pose_landmarks.landmark[11].x, resultsP.pose_landmarks.landmark[11].y])
                #Hombro derecho (landmark 12)
                pose_data.extend([resultsP.pose_landmarks.landmark[12].x, resultsP.pose_landmarks.landmark[12].y])
                # Codo izquierdo (landmark 13)
                pose_data.extend([resultsP.pose_landmarks.landmark[13].x, resultsP.pose_landmarks.landmark[13].y])
                # Codo derecho (landmark 14)
                pose_data.extend([resultsP.pose_landmarks.landmark[14].x, resultsP.pose_landmarks.landmark[14].y])
